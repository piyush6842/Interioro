...
const Footer = () => {
  return (
    ...
    <div className='flex bg-gray-100  w-screen h-[230px]'>
      ...
      <div className='my-4'><Link className='font-bold text-lg hover:underline hover:opacity-60' to='/about'>About</Link></div>
      <div className='my-4'><Link className='font-bold text-lg hover:underline hover:opacity-60' to='/products'>Products</Link></div>
      <div className='my-4'><Link className='font-bold text-lg hover:underline hover:opacity-60' to='/contact'>Contact</Link></div>
      </div>
      <div className='w-[300px] h-[230px] mx-8'>
